...
static {
	...
	try {
		...
		// On Android/ART, MethodHandles.findVirtual for canAccess may fail
		// even though the VM reports Java 9+. Fall back to Java 8 behavior
		// (canAccess returns true) rather than crashing.
