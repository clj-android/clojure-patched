...
// BEGIN clj-android patch: deterministic hashCode for reproducible AOT builds.
// Without this, LocalBinding inherits Object.hashCode() (identity-based),
// making PersistentHashMap iteration order over 'closes' non-deterministic
// across JVM runs.  This causes different field/ctor-param ordering in
// generated classes, producing non-reproducible .class and .dex output.
